...
namespace GymManagementDAL.Migrations
{
    ...
    [Migration("20251031180244_ModifyPhotoColumnInMemberTable")]
                    ...
                    b.ToTable("Members", t =>
                        {
                            ...
                            t.HasCheckConstraint("GymUser_PhoneCheck", "(LEN(Phone) = 11 AND Phone NOT LIKE '%[^0-9]%' AND (Phone LIKE '010%' OR Phone LIKE '011%' OR Phone LIKE '012%' OR Phone LIKE '015%'))");
                        });
                });
